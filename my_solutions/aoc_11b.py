...
class Shiny:
    ...
    def flasher_reaction(self, row_indicator, col_indicator):
        row_min, row_max, col_min, col_max = self.get_flash_grid(row_indicator=row_indicator,
        ...
        self.update_flashed(row_indicator, col_indicator)
        new_flashers = self.find_flashers(df=octo_grid[row_min:row_max, col_min:col_max], row_shift=row_min,
                                          col_shift=col_min)
